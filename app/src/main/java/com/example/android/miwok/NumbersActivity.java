...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("sixe", "temmokka", R.drawable.number_six, R.raw.number_six));
        ...
        ListView listView = (ListView) findViewById(R.id.numbers_words_list);
        listView.setAdapter(wordsAdapter);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // use the position variable to determine what sound needs to be played
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mediaPlayer = MediaPlayer.create(NumbersActivity.this, sound_to_play);
                    mediaPlayer.start();
